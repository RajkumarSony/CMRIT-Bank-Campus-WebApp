...
<form id="regForm"  name="myform" >
    ...
    <div class="input-group mb-3" style="margin-left: 50px; margin-right: 50px;">
		<div id="label" class="alert alert-info alert-dismissible" style="height: 40px;">
  			<h4 style="margin-top: -6px;">Descriptions</h4>
  		</div>
  		<div class="form-row" style="margin-top: 30px; margin-left: 30px; margin-right: 30px;">
			<div class="form-group col-md-12" style="background-color: #e5fbe5;">
				<h4 class ="heading" style="text-align: center;"><u>Terms & Conditions</u></h4><br>
				<h5 class ="lead" style="text-align: center;" id="data1"></h5>
				<h5 class ="lead" style="text-align: center;" id="data2"></h5>
			</div>
		</div>
		<div class="form-row">
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				<label class="fancy-checkbox element-left">
					...
					<span class="heading">Yes, I'm Agree from this discription! </span>
				</label>
			</div>
		</div>
	</div>
      	...
      	<div class="form-group col-md-12">
  			<div style="overflow:auto;">
    			<div style="float:center;">
    				<input type="button" id="submitbtn" onclick="javascript:personal();" disabled="disabled" class="btn btn-primary" style="margin-top: 20px;" value="Continue">
    			</div>
  			</div>

...
<head>
	<title>View Accounts | CMR IT Campus Bank</title>
	<meta charset="utf-8">
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages5" class="collapse">
								<ul class="nav">
									<li><a href="#" class="active">&#10003;&nbsp; View Accouts</a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading row">
							<div class="col-md-6">
								<h3 class="panel-title">View Amounts</h3>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Recent Opening A/c</h3>
									<div class="right">
									...
									<table class="table table-striped">
										<thead>
											<tr>
												...
												<th style="text-align: center; font-size: small;">Total Balance</th>
												<th style="text-align: center; font-size: small;">Address</th>
												<th style="text-align: center; font-size: small;">Mobile No.</th>
										...
										<%
  											try {
    											...
    											ResultSet rs = (ResultSet) con.createStatement().executeQuery("SELECT * FROM accounts");
    											while(rs.next()){
    												
    												ResultSet rs2 = (ResultSet) con.createStatement().executeQuery("SELECT * FROM contacts");
        											if(rs2.next()){
    									%>
										<tbody>
											<tr style="text-align: center;">
												...
												<td>&#x20B9; <span style="color: green;"><%=rs.getString("closing_bal") %></span></td>
												<td><%=rs2.getString("state") %></td>
												<td><%=rs2.getString("mobile_num") %></td>
												<td>
													<a class="label label-success" href="#">EDIT</a>
													<a class="label label-warning" href="#">VIEW</a>
													<a class="label label-danger" href="#">CLOSE</a>
												</td>
											</tr>
										<%		}}
								...
								<div class="panel-footer">
									<div class="row">
										...
										<div class="col-md-6 text-right"><a href="#" class="btn btn-primary">View All Accounts</a></div>
									</div>
								</div>
							</div>

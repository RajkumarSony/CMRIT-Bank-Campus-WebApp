...
<form class="form-auth-small" action="amount_withdraw" method="post">
			...
			<div class="form-row">
				...
				<div class="form-group col-md-4" style="margin-top: 30px;">		
					...
					<div class="input-group" style="margin-top: 40px; margin-bottom: 20px;">
						...
						<input type="number" class="form-control" id="amount" name="amount" required style="text-align: center;">

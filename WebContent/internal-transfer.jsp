...
<head>
	<title>Internal Transfer | CMR IT Campus Bank</title>
	<meta charset="utf-8">
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages1" class="collapse">
								<ul class="nav">
									<li><a href="#" class="active">&#10003;&nbsp; Internal Transfer</a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading row">
							<div class="col-md-6">
								<h3 class="panel-title">Internal Money Transfer</h3>
									...
									<table class="table table-striped">
										...
										<%
  											try {
    											...
    											ResultSet rs = (ResultSet) con.createStatement().executeQuery("SELECT * FROM beneficiary");
    											while(rs.next()){
    												double bal = rs.getDouble("max_limit");

    									%>
										<tbody>
											<tr style="text-align: center;">
												<td><a href="#"><%=rs.getString("holder_name") %></a></td>
												<td><%=rs.getString("acc_num") %></td>
												<td>--</td>
												<td>--</td>
												<td>&#x20B9; <span style="color: green;"><%=bal %></span></td>
												<td>

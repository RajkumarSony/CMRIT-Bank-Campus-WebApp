...
<form class="form-auth-small" action="search_acc_withdraw" method="post">
     ...
     ==== Search Account Details ====
   	...
   	<div class="tab" class="input-group mb-3" style="margin-left: 50px; margin-right: 50px;">
		<div id="label" class="alert alert-info alert-dismissible" style="height: 40px;">
  			<h4 style="margin-top: -6px;">Search Account Details</h4>
  		</div>

        <div class="form-row" style="margin-top: 60px;">
			<div class="form-row">
				<div style="margin-bottom: 0px;">
						<p>Note: Enter amount to be withdrawn.</p>
				</div>
				<div class="form-group col-md-4"></div>
				<div class="form-group col-md-4" style="margin-top: 30px;">			
    				<p><input type="text" class="form-control" id="acc_num" name="acc_num" maxlength="11" minlength="11" required style="text-align: center;"></p>
  				</div>
  				<div class="form-group col-md-4"></div>
  			</div>
  			<div class="form-row">
  				<div class="form-group col-md-12">
  					<button type="submit" class="btn btn-success" style="margin-top: 10px;">
  						<i class="fa fa-check-circle"></i>&nbsp; SEARCH
  					</button>

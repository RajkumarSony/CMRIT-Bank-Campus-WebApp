...
<form class="form-auth-small" id="myform" action="upload.do" method="post">

	<!--============================================
     ==== This "tab" for KYC Details ====
    =============================================-->
    ...
    <div class="tab" class="input-group mb-3" style="margin-left: 50px; margin-right: 50px;">
		<div id="label" class="alert alert-info alert-dismissible" style="height: 40px;">
  			<h4 style="margin-top: -6px;">Update KYC Details</h4>
  		</div>
        <div class="form-row" style="margin-top: 20px;">
			<div class="form-group col-md-12">
				<h4 style="text-align: left; margin-left: -10px;">Proof of Identity</h4>
				<hr style="margin-top: -5px; border-width: 1px; margin-left: -15px; margin-right: -15px; margin-bottom: 5px; border-color: #00AAFF;">
			</div>
		</div>
		<div class="form-row">
            <div class="form-group col-md-6">
    			<p style="text-align: left; font-size: small;">Document's Name*</p>
			...
			<div class="form-group col-md-6" style="margin-bottom: 50px;">
    			<p style="text-align: left; font-size: small;">Document No. / Identification No.*</p>
    			<p><input type="text" class="form-control" required></p>
    		</div>
   		</div>
   		<div class="form-row" style="margin-top: 40px;">
			<div class="form-group col-md-12">
				<h4 style="text-align: left; margin-left: -10px;">Proof of Address</h4>
				<hr style="margin-top: -5px; border-width: 1px; margin-left: -15px; margin-right: -15px; margin-bottom: 5px; border-color: #00AAFF;">
			</div>
		</div>
		<div class="form-row">
        ...
        <div class="form-row" style="margin-top: 20px;">
			<div class="form-group col-md-12">
				<h4 style="text-align: left; margin-left: -10px;">Upload Photo</h4>
				<hr style="margin-top: -5px; border-width: 1px; margin-left: -15px; margin-right: -15px; margin-bottom: 5px; border-color: #00AAFF;">
			</div>
		</div>
		<div class="form-row">
          	<div class="form-group col-md-9">
    			<p style="text-align: left; font-size: small;">Upload Photo*</p>
    			<input type="file" name="img[]" class="file" accept="image/*" onchange="img_reader(event,1);">
    			<div class="input-group">
					<input  type="text"  class="browse form-control" placeholder="Choose Image...">
					<span class="input-group-btn">
						<button class="browse btn btn-default" type="button">BROWSE !</button>
					</span>
				</div>
    			<button type="button" class="btn btn-success" style="margin-top: 30px;" onclick="upload_img(1);">
    				<i class="fa fa-check-circle"></i>&nbsp; UPLOAD PHOTO
    			</button>
   			</div>
			<div class="form-group col-md-3" style="margin-top: 20px;">
    			<div class="container-fluid">          
  					<img src="assets/img/avatar.jpg" id="output_img" class="img-thumbnail" alt="your_pic" style="width:130px; height:150px;">
				</div>
    		</div>
   		</div>
   		<div class="form-row" style="margin-top: 20px;">
			<div class="form-group col-md-12">
				<h4 style="text-align: left; margin-left: -10px;">Upload Signature</h4>
				<hr style="margin-top: -5px; border-width: 1px; margin-left: -15px; margin-right: -15px; margin-bottom: 5px; border-color: #00AAFF;">
			</div>
		</div>
   		<div class="form-row">
          	<div class="form-group col-md-9">
    			<p style="text-align: left; font-size: small;">Upload Photo*</p>
    			<input type="file" name="img[]" class="file" accept="image/*" onchange="img_reader(event,2);">
    			<div class="input-group">
					<input  type="text" class="browse form-control" placeholder="Choose Image...">
					<span class="input-group-btn">
						<button class="browse btn btn-default" type="button">BROWSE !</button>
    			...
    			<button type="button" class="btn btn-success" style="margin-top: 30px;" onclick="upload_sign(2);">
    				<i class="fa fa-check-circle"></i>&nbsp; UPLOAD SIGNATURE
    			</button>
   			</div>
			<div class="form-group col-md-3" style="margin-top: 20px;">
    			<div class="container-fluid">          
  					<img src="assets/img/sign.jpg" id="output_sign" class="img-thumbnail" alt="your_sign" style="width:130px; height:150px;">
				</div>
    		</div>
   		</div>
   		<div class="form-row" style="margin-top: 20px;">
			<div class="form-group col-md-12">
				<h4 style="text-align: left; margin-left: -10px;">Upload Documents</h4>
				<hr style="margin-top: -5px; border-width: 1px; margin-left: -15px; margin-right: -15px; margin-bottom: 5px; border-color: #00AAFF;">
			</div>
		</div>
		<div class="form-row">
          	<div class="form-group col-md-12" align="left">
    			<button type="button" class="btn btn-default" style="margin-top: 10px;" onclick="appendCode();">
    				<i class="fa fa-plus-square"></i>&nbsp; ADD DOCUMENT
    			</button>
    			<button type="button" class="btn btn-success" style="margin-top: 10px;" onclick="upload_all();">
    				<i class="fa fa-check-circle"></i>&nbsp; UPLOAD ALL
    			</button>
   			</div>
   		</div>
   		<div id="TextBoxesGroup">
   			<div id="TextBoxDiv1" class="form-row">
        	  	<div class="form-group col-md-8" style="margin-top: 10px;">
    				<p style="text-align: left; font-size: small;">Upload Document*</p>
    				<input type="file" name="img[]" class="file" id="file1" accept=".xlsx,.xls,image/*,.doc, .docx,.ppt, .pptx,.txt,.pdf" onchange="img_reader(event,11);">
    				<div class="input-group">
						<input type="text" id="file1" class="browse form-control" placeholder="Choose File...">
						<span class="input-group-btn">
							<button class="browse btn btn-default" type="button">BROWSE !</button>
						</span>
					</div>
					<div id="UploadedFileName1"> 
						<!--div style="text-align: left; font-size: small; margin-top: 10px;">
							<span>Uploaded File : </span>
        					<span id="fileText1" style="color: #a6b033"></span>
        				</div-->
        			</div>
   				</div>
				<div class="form-group col-md-4" style="margin-top: 8px;">
					<button type="button" class="btn btn-success" style="margin-top: 30px; margin-right: 5px;" onclick="upload_file(11,1);"><i class="fa fa-check-circle"></i>&nbsp; UPLOAD</button>
    				<button type="button" class="btn btn-danger" style="margin-top: 30px; margin-left: 5px;" onclick="removeCode(1);"><i class="fa fa-trash-o"></i></i>&nbsp; REMOVE</button>
    			</div>
   			</div>
   		</div>
   		<div class="form-row">
      	...
      	<div class="form-group col-md-12">
  			<div style="overflow:auto;">
    			<div style="float:center;">
      				<button class="btn btn-primary" style="margin-top: 20px;">Update KYC</button>
    			</div>
  			</div>

...
<head>
	<title>View Transactions | CMR IT Campus Bank</title>
	<meta charset="utf-8">
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages1" class="collapse">
								<ul class="nav">
									<li><a href="internal-transfer.html">&#10003;&nbsp; Internal Transfer</a></li>
						...
						<li>
							<a href="#subPages5" data-toggle="collapse" class="collapsed active"><i class="lnr lnr-pie-chart"></i><span> View Reports</span><i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages5" class="collapse">
								<ul class="nav">
									<li><a href="view-accounts.jsp">&#10003;&nbsp; View Accouts</a></li>
									<li><a href="#" class="active">&#10003;&nbsp; View Transactions</a></li>
...
<form id="regForm"  name="myform" >
    ...
    <div class="tab" class="input-group mb-3" style="margin-left: 50px; margin-right: 50px;">
  		<div class="input-group" style="margin-top: 30px; margin-bottom: 30px; margin-left: 10px; margin-right: 10px;">
			<input type="password" class="form-control" placeholder="Enter  Transaction  Id ...">
									...
									<table class="table table-striped">
										...
										<thead>
											<tr>
												...
												<th style="text-align: center; font-size: small;">From Account</th>
												<th style="text-align: center; font-size: small;">To Account</th>
										...
										<%
  											try {
    											...
    											ResultSet rs = (ResultSet) con.createStatement().executeQuery("SELECT * FROM transaction");
    											while(rs.next()){
    												
    									%>
										<tbody>
											<tr style="text-align: center;">
												<td><a href="#"><%=rs.getString("trans_id") %></a></td>
												<td><%=rs.getString("from_acc") %></td>
												<td><%=rs.getString("to_acc") %></td>
												<td>&#x20B9;<span style="color: green;"><%=rs.getString("trans_amount") %></td>

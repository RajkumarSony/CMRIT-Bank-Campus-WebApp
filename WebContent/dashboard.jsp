...
<head>
	<title>Dashboard | CMR IT Campus Bank</title>
	<meta charset="utf-8">
						...
						<li class="dropdown">
							<%
  								try {
    								...
    								ResultSet rs = (ResultSet) con.createStatement().executeQuery("SELECT * FROM `users` WHERE `session` = 'active'");
    								if(rs.next()){
    						%>
    	
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="assets/img/user.jpg" class="img-circle" alt="Avatar"> <span><%=rs.getString("uname") %></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
							<%		}
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><i>&#x20B9; </i><span>1,252</span></span>
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><i>&#x20B9; </i><span>10,203</span></span>
											<span class="title">Ladger Amount</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><i>&#x20B9; </i><span>3,340</span></span>
							...
							<div class="row">
								<div class="col-md-12" align="center">
									<div>
										<div class="col-md-12">
											<img id="wel" src="assets/img/welcome.png" alt="welcome-img" class="img-responsive">
										</div>
										<div class="col-md-12" id="wel-msg">
											<h3>Welcome To</h3>
											<h1 id="wel-msg" style="font-family: Candara;">" CMR IT Campus Bank "</h1>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="panel-body no-padding" align="center" style="overflow-x:auto;">
									<table class="table table-striped">
										<thead>
											<tr>
												<th style="text-align: center; font-size: small;">Transaction Id</th>
												<th style="text-align: center; font-size: small;">Name</th>
												<th style="text-align: center; font-size: small;">Amount</th>
												<th style="text-align: center; font-size: small;">Date &amp; Time</th>
												<th style="text-align: center; font-size: small;">Transaction Type</th>
												<th style="text-align: center; font-size: small;">Status</th>
											</tr>
										</thead>
										<tbody>
								...
								<div class="panel-footer">
									<div class="row">
										...
										<div class="col-md-6 text-right"><a href="#" class="btn btn-primary">View All Transactions</a></div>
									</div>
								</div>
							</div>

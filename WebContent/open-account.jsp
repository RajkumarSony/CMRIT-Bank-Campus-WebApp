...
<div class="col-md-12 text-center" >
	<div class="col-md-6">
		<a href="description.jsp" class="btn btn-default" style="height: 85px; width: 240px; margin-top: 30px; margin-bottom: 50px; border-radius: 50px;">
			<h3 class="lead" style="text-align: center;">01. Customer Details</h3>
		</a>
	</div>
	<div class="col-md-6">
		<a href="KYC-details.jsp" class="btn btn-default" style="height: 85px; width: 240px; margin-top: 30px; margin-bottom: 50px; border-radius: 50px;">
			<h3 class="lead" style="text-align: center;">02. Add KYC Details</h3>
		</a>
	</div>
</div>
<div class="col-md-12 text-center" >
	<img src="assets/img/welcome.png" width="25%" style="margin-top: -100px;">
</div>
<div class="col-md-12 text-center" >
	<a href="#" class="btn btn-primary" style="height: 85px; width: 240px; margin-bottom: 30px; border-radius: 50px;">
			<h3 class="lead" style="text-align: center;">Show Account Details</h3>
	</a>
</div>
</div>
</div>

...
<head>
	<title>Withdraw | CMR IT Campus Bank</title>
	<meta charset="utf-8">
...
<body>
	<%
		...
		{
			response.sendRedirect("search-acc-withdraw.jsp");
		}
		if (session.getAttribute("Amount")==null)
		{
			response.sendRedirect("page-withdraw.jsp");
		}
	%>
	<!-- WRAPPER -->
	<div id="wrapper">
					...
					<div class="panel panel-headline">
						<div class="panel-heading row">
							...
							<div class="col-md-6 text-right"  id="opt">
								...
								<a href="search-acc-withdraw.jsp" class="btn btn-success" disabled>
...
<form class="form-auth-small" action="withdrawForm" method="post">
    ...
    <div class="tab" class="input-group mb-3" style="margin-left: 50px; margin-right: 50px;">
		<div id="label" class="alert alert-info alert-dismissible" style="height: 40px;">
  			<h4 style="margin-top: -6px;">Withdraw Information</h4>
  		</div>
							...
							double amount = Double.parseDouble(amount_bal);
  								try {
    								...
    								if(rs.next()){
    									...
    									if(amount <= rs.getDouble("closing_bal")){
    									
    										closing_bal = rs.getDouble("closing_bal") - amount;
    									}
    									else{
    										response.sendRedirect("sufficient-bal.jsp");
    									}
        ...
        <div class="form-row" style="margin-top: 20px;">
			<div class="form-group col-md-12">
				<h4 style="text-align: left; margin-left: -10px;">Amount To Be Withdrawn</h4>
		...
		<div class="form-row">
          	<div class="form-group col-md-12">
    			<button type="submit" class="btn btn-success" style="margin-bottom: 30px;">
    				<i class="lnr lnr-upload" style="margin-right: 10px;"></i><span> AMOUNT WITHDRAW</span>
    			</button>

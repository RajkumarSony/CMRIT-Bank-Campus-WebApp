...
<form class="form-auth-small" action="validateForm.do" method="post">
     ...
     ==== User Authentication ====
   	...
   	<div class="tab" class="input-group mb-3" style="margin-left: 50px; margin-right: 50px;">
		<div id="label" class="alert alert-info alert-dismissible" style="height: 40px;">
  			<h4 style="margin-top: -6px;">User Authentication</h4>
  		</div>
			...
			<div class="form-row">
   				<div class="form-group col-md-12">
					<div class="input-group" style="margin-top: 40px; margin-bottom: 20px;">
						...
						<input type="text" class="form-control" name="opening_bal" required style="text-align: right;">
						<span class="input-group-addon">.00</span>
					</div>
					<div style="margin-bottom: 40px;">
						<p>Note: Enter initial amount to open new account.</p>
					</div>
    			</div>
    		</div>
		</div>
        <div class="form-row" style="margin-top: 60px;">
			<div class="form-group col-md-12">
				<h4 style="text-align: left; margin-left: -10px;">Enter validation code / (OTP)</h4>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-4" style="margin-top: 20px;">			
    				<p><input type="text" class="form-control" name="valid_code" maxlength="8" minlength="8" required style="text-align: center;"></p>
  				</div>
  				<div class="form-group col-md-4"></div>
  			</div>
  			<div class="form-row">
  			...
  			<div class="form-row">
  				<div class="form-group col-md-12">
  					<p><a href="http://localhost:8080/Demo23/send_code">Resend Validation Code on Your Email id?</a></p>
  				</div>
  			</div>
		</div>
	</div>

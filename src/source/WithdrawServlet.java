...
//================================================= Email ====================
				...
				String msg2 = "Hello "+holder_name+",\n\n"
							...
							+ "Your A/c "+acc_num+" has been self withdrawn by Rs. "+amount+" on "+dform.format(date)+".\n\n"
